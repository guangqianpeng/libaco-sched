...
extern void aco_share_stack_unref(aco_share_stack_t* sstk);
...
// aco's pointer passing from caller (resumer) to callee (yielder) 
extern __thread void* acosw_arg;

aco_attr_no_asan
extern void* aco_resume(aco_t* resume_co, void* arg);

extern void* aco_yield1(aco_t* yield_co, void* arg);

#define aco_yield(arg) (aco_yield1(aco_gtls_co, (arg)))
